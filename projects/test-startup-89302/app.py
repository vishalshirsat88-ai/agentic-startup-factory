...
from routes.test_case_manager_routes import test_case_manager_bp
from routes.test_environment_manager_routes import test_environment_manager_bp
...
def landing():
    return render_template(
        ...
        feature_1_title="Support for various testing frameworks, Automated test execution and reporting, Test case creation and editing, Test case execution and result tracking, Environment creation and editing, Environment configuration and setup, Test execution metrics and reporting, Test result analysis and visualization",
...
app.register_blueprint(test_case_manager_bp)
app.register_blueprint(test_environment_manager_bp)
