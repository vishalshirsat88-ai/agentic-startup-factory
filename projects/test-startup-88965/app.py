# [AUTO_WIRE IMPORTS]
from routes.user_authentication_routes import user_authentication_bp
from routes.test_management_routes import test_management_bp
from routes.deployment_management_routes import deployment_management_bp
...
def landing():
    return render_template(
        ...
        feature_1_title="User Registration, Login with Email/Password, Forgot Password, Test Case Management, Test Execution, Test Results Reporting, Continuous Integration, Continuous Deployment, Rollback Management, Test Coverage Reporting, Deployment Success/Failure Reporting, User Engagement Metrics",
...
app.register_blueprint(deployment_management_bp)
