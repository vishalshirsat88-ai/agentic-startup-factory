...
def landing():
    return render_template(
        ...
        product_description="AI-powered community platform for creatives to share, collaborate, and monetize their work in a secure, token-based ecosystem.",
        ...
        feature_1_title="AI-powered community platform, Token-based ecosystem, Secure collaboration tools, Monetization options, Commission-based sales",
