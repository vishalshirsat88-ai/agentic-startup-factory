...
def landing():
    return render_template(
        ...
        product_description="AI-powered personalized wellness and nutrition planning based on users' genetic profiles and lifestyle",
        ...
        feature_1_title="Genetic Profile Analysis, Personalized Nutrition Planning, Lifestyle and Preferences Integration, Meal Planning and Grocery List Generation, Subscription Management System, User Onboarding and Profile Creation, Meal Delivery Tracking and Feedback",
