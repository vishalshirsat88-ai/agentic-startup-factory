...
from routes.focus_tracker_routes import focus_tracker_bp
from routes.wellness_planner_routes import wellness_planner_bp
from routes.reward_system_routes import reward_system_bp
from routes.gaming_integration_routes import gaming_integration_bp
...
def landing():
    return render_template(
        ...
        feature_1_title="AI-powered focus tracker, Personalized mental wellness plans, Gamified rewards system, Integration with popular gaming platforms, User onboarding flow, Focus and wellness tracking flow, Reward redemption flow, Subscription-based model, In-app purchases",
...
app.register_blueprint(focus_tracker_bp)
app.register_blueprint(wellness_planner_bp)
app.register_blueprint(reward_system_bp)
app.register_blueprint(gaming_integration_bp)