...
from routes.automated_testing_routes import automated_testing_bp
...
def landing():
    return render_template(
        ...
        feature_1_title="Create test cases, Edit test cases, Delete test cases, Create test suites, Edit test suites, Delete test suites, Create test runs, Edit test runs, Delete test runs, View test results, Analyze test results, Generate reports, View analytics",
...
app.register_blueprint(automated_testing_bp)
