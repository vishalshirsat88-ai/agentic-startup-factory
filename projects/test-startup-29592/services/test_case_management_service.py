...
def get_test_case_management():
    test_cases = [
        {"id": 1, "name": "Smoke Test", "description": "Test basic functionality"},
        {"id": 2, "name": "Regression Test", "description": "Test functionality after changes"}
    ]
    test_case_ids = [1, 2, 3]
    filtered_test_cases = [case for case in test_cases if case["id"] in test_case_ids]
    return {"test_cases": filtered_test_cases}
