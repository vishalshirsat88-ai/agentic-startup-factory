...
def get_test_environment_management():
    # Initialize test environment management with default settings
    test_environment_settings = {
        "environment": "development",
        "test_suite": "default_test_suite"
    }
    # Set environment to 'production' for live test scenarios
    if "LIVE_TEST" in os.environ and os.environ["LIVE_TEST"] == "True":
        test_environment_settings["environment"] = "production"
    return test_environment_settings
