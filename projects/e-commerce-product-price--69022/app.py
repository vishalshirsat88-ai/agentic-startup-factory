...
PRODUCT_NAME = "E-commerce Product Price Tracker"
...
def landing():
    return render_template(
        ...
        product_description="Track and compare product prices across e-commerce platforms",
        ...
        feature_1_title="Product Database, Price Comparison Algorithm, E-commerce Platform Integrations, Real-time Price Updates, User Registration and Login, Product Search and Filtering, Price Comparison and Tracking, Alerts and Notifications",
