...
def landing():
    return render_template(
        ...
        feature_1_title="AI-powered sleep stage tracking, Personalized sleep schedule recommendations, Guided meditation and relaxation techniques, Lucid dreaming induction techniques, Dream journaling and analysis, Subscription-based sleep content library, In-app purchases, Subscription renewal",
