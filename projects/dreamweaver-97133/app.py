...
from routes.sleep_analysis_routes import sleep_analysis_bp
from routes.dream_journaling_routes import dream_journaling_bp
from routes.subscription_management_routes import subscription_management_bp
from routes.payments_gateway_routes import payments_gateway_bp
...
def landing():
    return render_template(
        ...
        product_description="AI-powered lucid dreaming assistant",
        ...
        feature_1_title="Sleep Pattern Analysis, Lucid Dreaming Detection, AI-powered Dream Journaling, Personalized Dream Insights, Customizable Dream Stimulation, Subscription Management, In-App Purchases Management, Lucid Dreaming Exercises and Techniques",
...
app.register_blueprint(sleep_analysis_bp)
app.register_blueprint(dream_journaling_bp)
app.register_blueprint(subscription_management_bp)
app.register_blueprint(payments_gateway_bp)
