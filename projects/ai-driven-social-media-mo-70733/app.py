...
PRODUCT_NAME = "AI-driven Social Media Monitoring Tool"
...
def landing():
    return render_template(
        ...
        product_description="Monitor social media conversations and provide data-driven insights for improved brand reputation",
        ...
        feature_1_title="Social Media Platform Integration, Conversational Sentiment Analysis, Influencer Identification and Tracking, Hashtag and Keyword Monitoring, Data Visualization and Insights",
