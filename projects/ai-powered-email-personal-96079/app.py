...
PRODUCT_NAME = "AI-powered Email Personalization"
...
def landing():
    return render_template(
        ...
        product_description="Automatically personalize email marketing campaigns with AI-driven suggestions",
        ...
        feature_1_title="AI-powered Email Content Generation, Email Campaign Performance Metrics Tracking, User Onboarding and Setup, Email Campaign Creation and Execution, AI-driven Suggestion Generation and Integration, Handling Email Bouncebacks and Opt-outs, Managing Email Campaign Blacklists and Whitelists, Real-time Analytics and Reporting",
