...
def landing():
    return render_template(
        ...
        feature_1_title="AI-powered focus music, Personalized mental wellness insights, Gamification for habit tracking, Mood tracking and analysis, Customizable focus sessions, Exclusive content and rewards",
