...
PRODUCT_NAME = "AI-powered Email Writer"
...
def landing():
    return render_template(
        ...
        product_description="Writes high-quality email responses and templates",
        ...
        feature_1_title="Email Template Library, AI-powered Email Response Generation, User Sign-up and Onboarding Flow, User Email Composition and Send Flow",
