# [AUTO_WIRE IMPORTS]
from routes.test_scheduling_routes import test_scheduling_bp
from routes.test_execution_routes import test_execution_bp
from routes.test_analytics_routes import test_analytics_bp
from routes.test_security_routes import test_security_bp
...
def landing():
    return render_template(
        ...
        feature_1_title="Test Run Scheduling, Test Case Selection, Test Execution Engine, Test Result Storage, Test Result Analysis, Test Trend Visualization, Data Encryption, Access Control",
...
app.register_blueprint(test_scheduling_bp)
