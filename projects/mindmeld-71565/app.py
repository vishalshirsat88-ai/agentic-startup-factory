...
def landing():
    return render_template(
        ...
        product_description="AI-powered virtual meeting facilitation and note-taking",
        ...
        feature_1_title="AI-powered meeting facilitation, Real-time note-taking and collaboration, Intelligent agenda planning and organization, Action item tracking and assignment, Virtual whiteboard and brainstorming, Integration with popular calendar and task management tools",
