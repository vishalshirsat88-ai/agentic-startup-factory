...
def landing():
    return render_template(
        ...
        feature_1_title="Pipeline creation, Pipeline scheduling, Pipeline monitoring, Test case creation, Test case execution, Test case result analysis, Environment creation, Environment provisioning, Environment monitoring, Report generation, Analytic generation, Data visualization",
