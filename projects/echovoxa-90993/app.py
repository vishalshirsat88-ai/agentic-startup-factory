...
def landing():
    return render_template(
        ...
        product_description="AI-powered vocal coach for music artists and singers",
        ...
        feature_1_title="User Management, Idea Management, Product Management, Vocal Analysis, Practice Sessions, Lessons, Payment Gateway",
