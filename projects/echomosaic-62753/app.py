...
def landing():
    return render_template(
        ...
        product_description="AI-powered virtual art studio for non-technical users",
        ...
        feature_1_title="Art Studio Interface, AI-powered Brush Strokes, Canvas Customization, Toolbox with Essential Features, Gallery to Showcase Artwork, Save and Load Artwork, AI-powered Color Palette Suggestions, Onboarding Flow for New Users, Creating a New Artwork, Editing and Customizing Artwork, Purchasing Premium Assets and Features",
