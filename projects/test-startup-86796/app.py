# [AUTO_WIRE IMPORTS]
from routes.pipeline_management_routes import pipeline_management_bp
from routes.test_case_management_routes import test_case_management_bp
from routes.deployment_and_rollback_routes import deployment_and_rollback_bp
...
def landing():
    return render_template(
        ...
        feature_1_title="Pipeline creation and editing, Pipeline scheduling and execution, Test case creation and editing, Test case execution and result tracking, Deployment to production environment, Rollback to previous version, Test execution metrics and analytics, Deployment success rate and trend analysis",
...
app.register_blueprint(pipeline_management_bp)
app.register_blueprint(test_case_management_bp)
app.register_blueprint(deployment_and_rollback_bp)
