...
def landing():
    return render_template(
        ...
        feature_1_title="User authentication and authorization, Test project creation and management, Test case creation and management, Test suite creation and management, Test run execution and results, Test result reporting and analytics, Test data encryption and security, Access control and authorization, Compliance with regulatory standards",
