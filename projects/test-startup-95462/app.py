...
from routes.integration_and_api_routes import integration_and_api_bp
...
def landing():
    return render_template(
        ...
        feature_1_title="Pipeline creation, Pipeline execution, Pipeline monitoring, Test case creation, Test case execution, Test case reporting, Report generation, Data analytics, Pipeline performance metrics, API integration, Webhook integration, Third-party service integration",
...
app.register_blueprint(integration_and_api_bp)
