...
def landing():
    return render_template(
        ...
        product_description="AI-powered music recommendation and collaboration platform for creators and producers",
        ...
        feature_1_title="AI-powered music recommendation engine, Collaboration tools for creators and producers, Music library with a vast collection of songs, User profiles and dashboards for tracking progress, Subscription management and billing system",
