...
from routes.test_run_management_routes import test_run_management_bp
...
def landing():
    return render_template(
        ...
        feature_1_title="Pipeline creation, Pipeline scheduling, Pipeline monitoring, Test case creation, Test case storage, Test case versioning, Test run creation, Test run execution, Test run reporting, Report generation, Analytics dashboard, Test run summary",
...
app.register_blueprint(test_run_management_bp)
