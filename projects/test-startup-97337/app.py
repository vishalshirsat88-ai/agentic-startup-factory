...
from routes.result_analytics_routes import result_analytics_bp
from routes.collaboration_tools_routes import collaboration_tools_bp
...
def landing():
    return render_template(
        ...
        feature_1_title="Pipeline creation, Pipeline scheduling, Pipeline monitoring, Test case creation, Test case execution, Test case reporting, Result visualization, Result analysis, Result reporting, User management, Role-based access control, Commenting and @mentioning",
...
app.register_blueprint(result_analytics_bp)
app.register_blueprint(collaboration_tools_bp)
