...
def landing():
    return render_template(
        ...
        feature_1_title="Natural Language Processing (NLP) API, Machine Learning (ML) API, User Registration and Login, Content Suggestion Feed, Content Filtering and Sorting, User Profile and Preference Management",
