...
available_test_cases = [
    ...
    {"id": 2, "name": "Registration Test"},
    {"id": 3, "name": "Forgot Password Test"}
]

# Get all assigned test cases
assigned_test_cases = [
    {"id": 1, "name": "Login Test", "status": "pending"},
    {"id": 2, "name": "Registration Test", "status": "running"}
]
...
return {
    ...
    "total_test_cases": len(available_test_cases) + len(assigned_test_cases)
}
