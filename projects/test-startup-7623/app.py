...
from routes.test_plans_routes import test_plans_bp
from routes.test_cases_routes import test_cases_bp
from routes.test_results_routes import test_results_bp
...
def landing():
    return render_template(
        ...
        feature_1_title="Automated testing pipeline, Real-time testing results, Customizable test cases, Handling of failing tests, Support for multiple testing frameworks, Error handling for incomplete test plans",
