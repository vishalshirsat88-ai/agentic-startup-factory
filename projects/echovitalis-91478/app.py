...
def landing():
    return render_template(
        ...
        product_description="AI-powered health coaching and personalized nutrition planning platform for seniors",
        ...
        feature_1_title="AI-powered health coaching, Personalized nutrition planning, Health data analysis, Customizable meal planning",
