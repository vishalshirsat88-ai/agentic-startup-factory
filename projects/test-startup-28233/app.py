...
from routes.result_analysis_routes import result_analysis_bp
...
def landing():
    return render_template(
        ...
        feature_1_title="Pipeline creation, Pipeline execution, Pipeline monitoring, Test case creation, Test case assignment, Test case reporting, Result filtering, Result grouping, Result charting, CI/CD tool integration, API integration, Webhook support",
...
app.register_blueprint(result_analysis_bp)
