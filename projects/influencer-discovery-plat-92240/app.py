...
PRODUCT_NAME = "Influencer Discovery Platform"
...
def landing():
    return render_template(
        ...
        product_description="Find and connect with influencers in specific niches and industries",
        ...
        feature_1_title="User Profile Creation and Management, Influencer Search and Filtering, Influencer Profile Details and Analytics, Influencer Outreach and Messaging, Influencer Collaboration and Content Creation, Influencer Reputation and Scoring System",
