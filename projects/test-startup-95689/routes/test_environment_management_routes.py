...
@test_environment_management_bp.route('/test_environment_management', methods=['GET'])
def test_environment_management_page():
    return render_template("test_environment_management.html")
