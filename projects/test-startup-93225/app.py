# [AUTO_WIRE IMPORTS]
from routes.pipeline_manager_routes import pipeline_manager_bp
from routes.test_runner_routes import test_runner_bp
from routes.deployment_manager_routes import deployment_manager_bp
from routes.analytics_and_insights_routes import analytics_and_insights_bp
...
def landing():
    return render_template(
        ...
        feature_1_title="Pipeline creation and editing, Pipeline execution and monitoring, Test execution and reporting, Test result analysis and feedback, Build deployment and rollback, Environment management and configuration, Pipeline performance metrics and analytics, Test result analysis and trends",
...
app.register_blueprint(pipeline_manager_bp)
app.register_blueprint(test_runner_bp)
app.register_blueprint(deployment_manager_bp)
app.register_blueprint(analytics_and_insights_bp)
