...
from routes.testcases_routes import testcases_bp
from routes.environments_routes import environments_bp
...
def landing():
    return render_template(
        ...
        feature_1_title="Automated Testing, Test Pipeline Integration, Real-time Reporting, User Sign-up and Login, Test Case Creation and Management, Handling Failed Tests, Dealing with Unstable Test Environments",
