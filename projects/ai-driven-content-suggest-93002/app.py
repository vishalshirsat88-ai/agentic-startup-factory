...
PRODUCT_NAME = "AI-driven Content Suggestions"
...
def landing():
    return render_template(
        ...
        product_description="Provide personalized content suggestions for blog posts, social media, and email marketing",
        ...
        feature_1_title="Personalized Content Recommendation Engine, Content Categorization and Filtering, Real-time Content Suggestions, User Login and Profile Setup, Content Discovery and Suggestion Display, User Engagement and Feedback Loop, Handling Duplicate or Outdated Content, Handling User Blocking or Muting Content Types",
