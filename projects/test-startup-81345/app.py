...
def landing():
    return render_template(
        ...
        feature_1_title="Pipeline creation, Pipeline editing, Pipeline deletion, Test case creation, Test case editing, Test case execution, Test run creation, Test run execution, Test run reporting, Report generation, Analytics dashboard",
