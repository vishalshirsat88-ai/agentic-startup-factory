...
from routes.test_automation_routes import test_automation_bp
from routes.reporting_and_analytics_routes import reporting_and_analytics_bp
from routes.security_and_compliance_routes import security_and_compliance_bp
...
def landing():
    return render_template(
        ...
        feature_1_title="Create and manage pipeline stages, Configure testing tools and environments, Create and manage test scripts, Integrate with CI/CD tools, Generate test reports and dashboards, Analyze testing data and trends, Implement pipeline security measures, Comply with regulatory and industry standards",
...
app.register_blueprint(test_automation_bp)
app.register_blueprint(reporting_and_analytics_bp)
app.register_blueprint(security_and_compliance_bp)
