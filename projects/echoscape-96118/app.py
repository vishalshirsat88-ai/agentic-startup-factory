...
from routes.landscape_generator_routes import landscape_generator_bp
from routes.payments_routes import payments_bp
from routes.subscription_manager_routes import subscription_manager_bp
from routes.ideas_routes import ideas_bp

from flask import Flask, render_template, redirect
from flask import url_for

PRODUCT_NAME = "EchoScape"
...
def landing():
    return render_template(
        ...
        product_description="AI-powered 3D virtual reality landscape generator for people with visual impairments",
        ...
        feature_1_title="AI-powered 3D landscape generation, Customizable 3D environment, Accessibility-focused interface, Subscription-based service for 3D landscape generation, Premium features and customization options",
...
app.register_blueprint(landscape_generator_bp)
app.register_blueprint(payments_bp)
app.register_blueprint(subscription_manager_bp)
