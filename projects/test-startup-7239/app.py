...
from routes.test_pipelines_routes import test_pipelines_bp
...
def landing():
    return render_template(
        ...
        feature_1_title="Automated Testing, Real-Time Results, Error Handling, Test Case Duplication",
...
app.register_blueprint(test_pipelines_bp)
