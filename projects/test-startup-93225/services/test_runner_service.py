...
def get_test_runner():
    # Initialize test runner with default settings
    default_settings = {
        "test_name": "Default Test",
        "test_description": "This is a default test",
        "test_status": "pending"
    }

    # Add optional parameters for custom test settings
    test_settings = {
    ...
    # Determine the final test runner object based on business logic
    final_test_runner = {
        **default_settings,
        **test_settings
    }

    return final_test_runner
