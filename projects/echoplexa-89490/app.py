...
def landing():
    return render_template(
        ...
        product_description="AI-powered personalized 3D home decor design and shopping platform",
        ...
        feature_1_title="Personalized 3D Home Decor Design, AI-powered Furniture and Decor Product Suggestions, Commission-based Sales Platform, 3D Room Visualization, Product Customization, Inconsistent User Input Handling, Product Unavailability and Out-of-Stock Scenarios, Payment Failure and Refund Processing, Product Return and Exchange Policy",
