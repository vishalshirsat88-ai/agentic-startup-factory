# [AUTO_WIRE IMPORTS]
from routes.pipeline_module_routes import pipeline_module_bp
from routes.test_data_module_routes import test_data_module_bp
from routes.notifications_module_routes import notifications_module_bp
...
def landing():
    return render_template(
        ...
        feature_1_title="Pipeline creation, Job scheduling, Test results analysis, Test data storage, Data import/export, Data synchronization, Email notifications, Slack notifications, Custom notification templates, Pipeline execution metrics, Test results visualization, Custom dashboards",
...
app.register_blueprint(pipeline_module_bp)
app.register_blueprint(test_data_module_bp)
app.register_blueprint(notifications_module_bp)
