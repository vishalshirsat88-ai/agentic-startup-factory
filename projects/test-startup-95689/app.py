...
from routes.test_environment_management_routes import test_environment_management_bp
...
def landing():
    return render_template(
        ...
        feature_1_title="User registration, Login functionality, Role-based access control, Test case creation, Test suite management, Test run execution, Environment creation, Environment setup and teardown, Environment configuration, Test result analysis, Test coverage reporting, Defect tracking",
...
app.register_blueprint(test_environment_management_bp)
