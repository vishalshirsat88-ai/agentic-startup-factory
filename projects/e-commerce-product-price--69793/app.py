...
def landing():
    return render_template(
        ...
        feature_1_title="Product Price Database with Real-time Updates, Cross-Platform Price Comparison, Alert System for Price Drops, Customizable Product Tracking, User Profile Management",
