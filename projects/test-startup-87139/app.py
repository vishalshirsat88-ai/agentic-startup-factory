...
from routes.test_results_analysis_routes import test_results_analysis_bp
from routes.integration_and_automation_routes import integration_and_automation_bp
...
def landing():
    return render_template(
        ...
        feature_1_title="Test Case Management, Automated Test Execution, Test Result Reporting, Defect Tracking, CI/CD Integration, Automated Test Scripting",
...
app.register_blueprint(test_results_analysis_bp)
app.register_blueprint(integration_and_automation_bp)
