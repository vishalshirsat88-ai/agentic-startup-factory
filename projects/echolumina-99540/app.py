...
def landing():
    return render_template(
        ...
        product_description="AI-powered personalized emotional wellness and stress management platform for the visually impaired community",
        ...
        feature_1_title="AI-powered personalized emotional wellness and stress management, Customizable mood tracking and analysis, Personalized stress management plans, Integration with accessible technology, Real-time emotional feedback, Subscription-based model with premium features and data analytics for mental health professionals",
