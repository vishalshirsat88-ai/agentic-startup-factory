...
def landing():
    return render_template(
        ...
        product_description="An AI-powered platform that generates and sells immersive, interactive 3D experiences for museums, galleries, and cultural institutions.",
        ...
        feature_1_title="AI-powered 3D Experience Generation, Interactive 3D Experience Platform, Subscription-based Licensing Model, Sponsored Content and Advertising Integration, Experience Publishing and Sales, User Experience and Engagement Tracking, Subscription Management and Renewal, Experience Analytics and Reporting",
