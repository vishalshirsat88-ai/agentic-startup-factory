...
def landing():
    return render_template(
        ...
        product_description="AI-powered audio discovery platform for visually impaired individuals",
        ...
        feature_1_title="Audio Identification, Personalized Audio Recommendations, Accessible Music Library, Real-time Audio Analysis, Audio Content Filtering, Subscription-based with premium features and sponsored content integration",
