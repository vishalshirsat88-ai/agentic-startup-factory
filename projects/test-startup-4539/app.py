...
from routes.test_planner_routes import test_planner_bp
from routes.test_executor_routes import test_executor_bp
from routes.payments_routes import payments_bp
from routes.feedback_system_routes import feedback_system_bp
...
def landing():
    return render_template(
        ...
        feature_1_title="Automated Testing, Real-time Feedback, Invalid Input Handling, API Connection Failure Detection",
...
app.register_blueprint(test_planner_bp)
