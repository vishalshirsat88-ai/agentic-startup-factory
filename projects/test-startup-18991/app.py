...
def landing():
    return render_template(
        ...
        feature_1_title="Schedule tests, Run tests on demand, Generate test reports, Create and manage test cases, Create and manage test suites, Associate test cases with test suites, Test coverage analysis, Test execution metrics, Test failure analysis, Integrate with CI/CD tools, Integrate with version control systems, Integrate with issue tracking systems",
