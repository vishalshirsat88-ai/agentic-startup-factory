...
from routes.testrunner_routes import testrunner_bp
...
def landing():
    return render_template(
        ...
        feature_1_title="Automated Testing, Continuous Integration, Create Test Case, Run Automated Tests, View Test Results, Handling Failing Tests, Debugging Test Failures",
...
app.register_blueprint(testrunner_bp)
