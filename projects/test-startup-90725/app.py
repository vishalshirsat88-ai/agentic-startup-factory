...
def landing():
    return render_template(
        ...
        feature_1_title="Pipeline creation, Pipeline editing, Pipeline deletion, Test execution, Test result logging, Test retry management, Test data creation, Test data editing, Test data deletion, Test result dashboard, Test result reporting, Analytics and visualization",
