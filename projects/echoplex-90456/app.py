...
from routes.participant_management_routes import participant_management_bp
...
def landing():
    return render_template(
        ...
        feature_1_title="AI-powered event planning, Virtual event creation, Immersive experience management, Event planning and management, Virtual event creation and deployment, Participant engagement and feedback",
...
app.register_blueprint(participant_management_bp)
